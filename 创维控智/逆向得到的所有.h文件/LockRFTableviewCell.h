...
@interface LockRFTableviewCell : UITableViewCell <MBSliderViewDelegate>
{
    ...
    id <LockRFTableViewCellDelegate> _delegate;
}

@property(retain, nonatomic) id <LockRFTableViewCellDelegate> delegate; // @synthesize delegate=_delegate;
