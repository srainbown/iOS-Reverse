...
@class AppDelegate, NSMutableArray, NSString, UIGridView, UIImageView, UITextField, UIView;

@interface GKDigMenuViewController : UIViewController <UIGridViewDelegate, UITextFieldDelegate>
{
    _Bool message;
    _Bool flag;
    ...
    UITextField *_textLoveNum;
    UIImageView *_imageIsLove;
}

@property(nonatomic) __weak UIImageView *imageIsLove; // @synthesize imageIsLove=_imageIsLove;
@property(nonatomic) __weak UITextField *textLoveNum; // @synthesize textLoveNum=_textLoveNum;
