...
@class NSData, NSMutableArray, NSString, XGAsyncReadPacket, XGAsyncSocketPreBuffer, XGAsyncWritePacket;

@interface XGAsyncSocket : NSObject
{
    unsigned int flags;
